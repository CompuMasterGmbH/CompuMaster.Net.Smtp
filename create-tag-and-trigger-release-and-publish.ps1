...
[string]$githubProjectUrl = 'https://github.com/CompuMasterGmbH/CompuMaster.Net.Smtp/' #must contain trailing slash!
[string]$masterBranchName = "master" #ususally 'master' or 'main'
[string]$assemblyVersionSourceFilePath = ".\CompuMaster.Net.Smtp\CompuMaster.Net.Smtp.vbproj"
