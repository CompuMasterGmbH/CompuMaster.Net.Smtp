...
Friend NotInheritable Class Strings
    ...
    Public Shared Function Left(ByVal value As String, ByVal number As Integer) As String
        If value Is Nothing Then
            Return ""
        ElseIf number >= value.Length Then
            Return value
        Else
    ...
    Public Shared Function Right(ByVal value As String, ByVal number As Integer) As String
        If value Is Nothing Then
            Return ""
        ElseIf number >= value.Length Then
            Return value
